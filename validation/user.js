...
{
errorMessage+="Please provide your postal box number/Zip/Post code.\n";
validationVerified=false;
}
...
if (messageForm.fname.value=="")
{
errorMessage+="first name not filled!\n";
validationVerified=false;
}
if (messageForm.lname.value=="")
{
errorMessage+="last name not filled!\n";
validationVerified=false;
}
if (messageForm.email.value=="")
{
errorMessage+="email not filled!\n";
validationVerified=false;
}
