...
margin:0;
padding:0;
background:<?php if(@$background_color=='#000000') echo '#bd6f2f'; else echo @$background_color; ?> url("<?php if(@$background=='') echo '../images/base-bg.gif'; else echo '../images/'. @$background. ''; ?>") repeat-x top;
